...
<Frame>
  <img src="/images/screenshots/image-to-prompt.jpg" alt="Image to Prompt — generated description" style="width: 100%; height: auto; border-radius: 12px;" />
</Frame>
...
Every image you hand to this tool is saved to `~/Pictures/Dax Shots/Image to Prompt`,
named the way macOS names screenshots, so you can always find it again.
