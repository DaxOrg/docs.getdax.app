...
- **Sign up** with your name and email. We'll send you a code; type it in
  ...
  upgrade to **Pro** ($10/month) via Stripe any time.
...
Need more credits mid-month? Buy a one-time credit pack from the **Usage**
window — credits are added instantly and last until the end of the month.

| Pack | Price | What you get |
| --- | --- | --- |
| AI Boost | $5 | +500 Ask AI, +500 text transforms, +10 Deep Research |
| Image Boost | $5 | +100 image questions, +50 image generations |
| Full Boost | $10 | Everything in both packs |
