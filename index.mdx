...
<Note>
  Dax is invite-only. Activate with an invite code, or press **Request
  access** on the invite screen to join the waitlist — see [How Dax
  works](/how-dax-works) for details.
</Note>
