...
description: "Fourteen menu-bar tools for developers who build with AI — each a keystroke away."
---

Dax is a macOS menu-bar app that puts fourteen small, sharp tools within a
keystroke. Every tool has its own global shortcut — press it from anywhere,
and the tool floats up over whatever you're doing, does its one job, and gets
out of the way. Nothing needs a Dock icon or a window switch.
