...
| [Command History](/tools/command-history) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>Y</kbd> | - | Fuzzy-search your shell history and drop a command into your terminal |
| [Image to Text](/tools/image-to-text) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>R</kbd> | - | Pull text out of any image with on-device OCR |
| [Secrets](/tools/secrets) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>V</kbd> | - | Hand secrets to coding agents without pasting them |
| [Context Fill](/tools/context-fill) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>X</kbd> | ✓ | Snip a form question, get a paste-ready answer |
| [PRD Maker](/tools/prd-maker) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>E</kbd> | ✓ | Say what you want to build and get the brief |
...
| [Herdr](/tools/herdr) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>.</kbd> | - | A herd of coding agents, locally or on a server |
...
| [Clipboard History](/tools/clipboard-history) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>C</kbd> | - | Re-paste anything you've copied |
