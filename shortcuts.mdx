...
| --- | --- | :---: | --- |
| [Frequent CLIs](/tools/frequent-clis) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>Return</kbd> | - | Type your go-to commands into the focused app |
...
| [Inject MD or Skill](/tools/inject-md) | <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>A</kbd> | ◐ | Drop AGENTS.md, install a skill, or share a file as a link |
...
<Note>
  <kbd>⌃</kbd> is Control, <kbd>⌥</kbd> is Option, and <kbd>Return</kbd> is the Return/Enter key.
